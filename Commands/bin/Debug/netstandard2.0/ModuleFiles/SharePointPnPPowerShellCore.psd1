@{
    ...
    FunctionsToExport = '*'
    CmdletsToExport = 'Add-App','Add-ContentType','Add-ContentTypeToList','Add-CustomAction','Add-EventReceiver','Add-Field','Add-FieldFromXml','Add-FieldToContentType','Add-NavigationNode','Connect-Online','Disable-Feature','Enable-Feature','Get-App','Get-AvailableClientSideComponents','Get-ClientSideComponent','Get-ClientSidePage','Get-ContentType','Get-Context','Get-CustomAction','Get-EventReceiver','Get-Feature','Get-Field','Get-Folder','Get-HomePage','Get-JavaScriptLink','Get-List','Get-ListItem','Get-MasterPage','Get-NavigationNode','Get-PropertyBag','Get-RequestAccessEmail','Get-StorageEntity','Get-SubWeb','Get-TenantAppCatalogUrl','Get-View','Get-Web','Get-WebTemplate','Install-App','New-Site','New-Web','Publish-App','Remove-App','Remove-ContentType','Remove-ContentTypeFromList','Remove-CustomAction','Remove-EventReceiver','Remove-Field','Remove-FieldFromContentType','Remove-NavigationNode','Send-RestRequest','Set-Field','Set-HomePage','Set-MasterPage','Set-MinimalDownloadStrategy','Set-NavigationNode','Set-PropertyBagValue','Uninstall-App','Unpublish-App','Update-App'
    VariablesToExport = '*'
